...
- 단위·수량·단가가 있으면 함께 추출합니다. "미정"·"별도"·"소비자 직접구매" 등 합계 미포함 항목은 isOption=true, amount=0.
- 견적서 메타(부가세 포함 여부, 총액, 평형, 이윤·공과잡비 %와 명칭, 공사기간)도 찾습니다. 명시가 없으면 null.
- 소계·합계·이윤·부가세 줄은 items에 넣지 않습니다.`,
      messages: [
        {
          role: "user",
